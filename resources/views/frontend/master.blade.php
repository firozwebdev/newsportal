...
<body>
	...
	<div id="container">
			...
			<div class="header-banner-place">
				<div class="container">
					...
					<div class="advertisement">
						<a href="index.html#"><img src="upload/addsense/620x80.jpg')}}" alt=""></a>
					</div>
				</div>
			</div>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link features" href="index.html#">Features <i class="fa fa-angle-down" aria-hidden="true"></i></a>
								<div class="megamenu">
									<div class="row">
										<div class="col-lg-3">
							...
							<li class="nav-item">
								<a class="nav-link world" href="index.html#">World <i class="fa fa-angle-down" aria-hidden="true"></i></a>
								<div class="mega-posts-menu">
									<div class="posts-line">
										<ul class="filter-list">
											<li><a href="index.html#">All</a></li>
											<li><a href="index.html#">Politic</a></li>
										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s23.jpg')}}" alt="">
														</a>
							...
							<li class="nav-item">
							  <a class="nav-link sport" href="index.html#">Sport <i class="fa fa-angle-down" aria-hidden="true"></i></a>
								<div class="mega-posts-menu">
									<div class="posts-line">
										<ul class="filter-list">
											<li><a href="index.html#">All</a></li>
										...
										<div class="row">
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s30.jpg')}}" alt="">
														</a>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s31.jpg')}}" alt="">
														</a>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s32.jpg')}}" alt="">
														</a>
														<a href="index.html#" class="category category-sport">winter sports</a>
													</div>
													<h2><a href="single-post.html">Travelling is part of our life</a></h2>
													<ul class="post-tags">
														<li><i class="lnr lnr-user"></i>by <a href="index.html#">John Doe</a></li>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s29.jpg')}}" alt="">
														</a>
							...
							<li class="nav-item">
							  <a class="nav-link tech" href="index.html#">Tech <i class="fa fa-angle-down" aria-hidden="true"></i></a>
								<div class="mega-posts-menu">
									<div class="posts-line">
										<div class="row">
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s37.jpg')}}" alt="">
														</a>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s38.jpg')}}" alt="">
														</a>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s39.jpg')}}" alt="">
														</a>
														<a href="index.html#" class="category category-tech">Tech</a>
													</div>
													<h2><a href="single-post.html">Travelling is part of our life</a></h2>
											...
											<div class="col-lg-3 col-md-6">
												<div class="news-post standart-post">
													<div class="post-image">
														<a href="http://nunforest.com/minberi-mag/single-post">
															<img src="{{ asset('frontend/upload/blog/s2.jpg')}}" alt="">
														</a>
														<a href="index.html#" class="category category-tech">Tech</a>
													</div>
													<h2><a href="single-post.html">Travelling is part of our life</a></h2>
							...
							<li class="nav-item dropdown">
								<a class="nav-link travel" href="index.html#">Travel <i class="fa fa-angle-down" aria-hidden="true"></i></a>
							</li>
							<li class="nav-item drop-link">
								<a class="nav-link food" href="index.html#">Pages <i class="fa fa-angle-down" aria-hidden="true"></i></a>
								<ul class="dropdown">
		...
		<!-- End Header -->
        @if (request()->is('/'))
           @include('frontend.partials.slider_news')
        @endif
						...
						<div class="sidebar theiaStickySidebar">
							...
							<div class="widget slider-widget">
								...
								<div class="flexslider">
									<ul class="slides">
										<li>
											<img alt="" src="{{ asset('frontend/upload/blog/s14.jpg')}}" />
										...
										<li>
											<img alt="" src="{{ asset('frontend/upload/blog/s13.jpg')}}" />
											<div class="slider-caption">
										...
										<li>
											<img alt="" src="{{ asset('frontend/upload/blog/s26.jpg')}}" />
											<div class="slider-caption">
												<a href="index.html#" class="category category-world">Business</a>
								...
								<ul class="small-posts">
									<li>
										<a href="single-post.html">
											<img src="{{ asset('frontend/upload/blog/th1.jpg')}}" alt="">
										</a>
										<div class="post-cont">
									...
									<li>
										<a href="single-post.html">
											<img src="{{ asset('frontend/upload/blog/th2.jpg')}}" alt="">
										</a>
										<div class="post-cont">
											<h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
											<ul class="post-tags">
												<li><i class="lnr lnr-user"></i>by <a href="index.html#">Besim Dauti</a></li>
											</ul>
										</div>
									</li>
									<li>
										<a href="single-post.html">
											<img src="{{ asset('frontend/upload/blog/th3.jpg')}}" alt="">
										</a>
										<div class="post-cont">
											<h2><a href="single-post.html">Eating traditional food is more healthy</a></h2>
											<ul class="post-tags">
												<li><i class="lnr lnr-user"></i>by <a href="index.html#">Admin Mag</a></li>
											</ul>
										</div>
									</li>
									<li>
										<a href="single-post.html">
											<img src="{{ asset('frontend/upload/blog/th4.jpg')}}" alt="">
										</a>
										<div class="post-cont">
											<h2><a href="single-post.html">Visiting antic countries is John Doe hobby.</a></h2>
											<ul class="post-tags">
												<li><i class="lnr lnr-user"></i>by <a href="index.html#">Helena Doe</a></li>
											</ul>
										</div>
									</li>
								</ul>
							...
							<div class="advertisement">
								<a href="index.html#"><img src="upload/addsense/300x250.jpg')}}" alt=""></a>
							</div>

							<div class="widget tabs-widget">
								<nav class="nav nav-tabs" id="myTab" role="tablist">
									<a class="nav-item nav-link active" id="nav-popular-tab" data-toggle="tab" href="index.html#nav-popular" role="tab" aria-controls="nav-popular" aria-selected="true">Popular</a>
									<a class="nav-item nav-link" id="nav-recent-tab" data-toggle="tab" href="index.html#nav-recent" role="tab" aria-controls="nav-recent" aria-selected="false">Recent</a>
									<a class="nav-item nav-link" id="nav-comments-tab" data-toggle="tab" href="index.html#nav-comments" role="tab" aria-controls="nav-comments" aria-selected="false">Comments</a>
								</nav>
								<div class="tab-content" id="nav-tabContent">
									<div class="tab-pane fade show active" id="nav-popular" role="tabpanel" aria-labelledby="nav-popular-tab">
										<ul class="small-posts">
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th5.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">New alternatives are more productive</a></h2>
													<ul class="post-tags">
											...
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th6.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
													<ul class="post-tags">
											...
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th7.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">Eating traditional food is more healthy</a></h2>
													<ul class="post-tags">
											...
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th8.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">Visiting antic countries is John Doe hobby.</a></h2>
													<ul class="post-tags">
									...
									<div class="tab-pane fade" id="nav-recent" role="tabpanel" aria-labelledby="nav-recent-tab">
										<ul class="small-posts">
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th9.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">New alternatives are more productive</a></h2>
													<ul class="post-tags">
											...
											<li>
												<a href="single-post.html">
													<img src="{{ asset('frontend/upload/blog/th10.jpg')}}" alt="">
												</a>
												<div class="post-cont">
													<h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
													<ul class="post-tags">
					...
					<div class="row">
						<div class="col-lg-2 col-md-3 col-sm-4 col-6">
							<div class="news-post thumb-post">
								<div class="post-image">
									<a href="http://nunforest.com/minberi-mag/single-post">
										<img src="{{ asset('frontend/upload/blog/s1.jpg')}}" alt="">
									</a>
								</div>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-6">
							<div class="news-post thumb-post">
								<div class="post-image">
									<a href="http://nunforest.com/minberi-mag/single-post">
										<img src="{{ asset('frontend/upload/blog/s9.jpg')}}" alt="">
									</a>
								</div>
								<h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a></h2>
							</div>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-6">
							<div class="news-post thumb-post">
								<div class="post-image">
									<a href="http://nunforest.com/minberi-mag/single-post">
										<img src="{{ asset('frontend/upload/blog/s12.jpg')}}" alt="">
									</a>
								</div>
								<h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a></h2>
							</div>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-6">
							<div class="news-post thumb-post">
								<div class="post-image">
									<a href="http://nunforest.com/minberi-mag/single-post">
										<img src="{{ asset('frontend/upload/blog/s16.jpg')}}" alt="">
									</a>
								</div>
								<h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a></h2>
							</div>
		...
		<footer>
			<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="footer-widget text-widget">
								<h1><a href="index.html"><img src="{{ asset('frontend/images/logo.png')}}" alt=""></a></h1>
				...
				<div class="down-footer">
					...
					<p>&copy; Copyright By Sabuz 2023<a href="index.html#" class="go-top"><i class="fa fa-caret-up" aria-hidden="true"></i></a></p>
				</div>
